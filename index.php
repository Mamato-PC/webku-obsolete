	...
	<body>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1">
			<tr>
				...
				<?php
				$lihat = $lala->query("select * from tbl_artikel order by id");
				foreach($lihat as $tampil){
				?>
				<tr>
					<td><font size="5"><?=$tampil['judul']?></font></td>
				</tr>
				<tr>
					<td><b>Diposting tanggal:</b> <?=$tampil['tgl']?></td>
				</tr>
				<tr><td>&nbsp;</td></tr>
				<tr>
					<td class="ganteng"><?=nl2br($tampil['headline'])?> ... <a href="lengkap.php?id=<?php echo $tampil['id']; ?>">Baca lengkap</a></td>
				</tr>
				<tr><td>&nbsp;</td></tr>
				<tr>
					<td><b>Pengirim:</b> <?=$tampil['pengirim']?></td>
				</tr>
				<tr><td>&nbsp;</td></tr>
				<?php } ?>
				</table>
